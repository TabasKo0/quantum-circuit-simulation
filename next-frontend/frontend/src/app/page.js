...
const DualSphere = dynamic(() => import('../components/DualSphere'), { ssr: false });
    ...
    <main className="min-h-screen bg-[#0b1020] text-gray-100">
      ...
      <div className="flex flex-col gap-8 px-4">
        ...
        <div className="bg-gray-900 rounded-lg shadow-lg overflow-hidden">
          <h3 className="text-2xl font-bold text-center py-4 bg-gray-800 border-b-2 border-cyan-500">Dual Bloch Sphere Visualization</h3>
          <DualSphere stateVector={stateVector} />
        </div>
      </div>
    </main>
  );
